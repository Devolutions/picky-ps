...
Picky sign a CSR with his root CA, with the command `Register-Certificate`, a CSR will be created and send to Picky Server to be signed, the signed certificate is returned.

The parameters are needed:

- `PickyRealm`, the Realm of your Picky Server
...
[source, sh]
----
PS > Register-Certificate -PickyRealm Wayk.net -PickyApiKey 123456
----
