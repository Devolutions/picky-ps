...
=== Get Certificates
The list of signed certificates can be show with the command `Get-Certificates`
...
You can save certificate who have been signed on the backend of the Picky server with the command `Save-CertificateOnServer`
...
You can remove certificate with the command `Remove-Certificate`
...
[source, sh]
----
PS > Remove-Certificate -CertificateID 2c082069-5281-4ed4-aadb-cd0fbb15bc30
----
